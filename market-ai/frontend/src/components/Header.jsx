...
export default function Header({ darkMode, setDarkMode, activeAsset }) {
    ...
    return (
        <header className="flex items-center justify-between p-4 border-b border-light-border dark:border-dark-border bg-light-card dark:bg-dark-card transition-colors duration-200">
            <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-4">
                <h1 className="text-2xl font-black tracking-tighter text-blue-700 dark:text-blue-400">VANTIQ<span className="text-gray-800 dark:text-white">-AI</span></h1>
            ...
            <div className="flex items-center gap-4 sm:gap-6">
                <div className="flex items-center gap-3">
                    {activeAsset && (
                        <span className="px-2.5 py-1 bg-gray-900 dark:bg-gray-800 text-white text-[10px] sm:text-xs font-bold rounded shadow-sm tracking-wider uppercase border border-gray-700">
                            {activeAsset}
                        </span>
                    )}
